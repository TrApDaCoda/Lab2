...
public class GameSystem {
    ...
    public void addApe() {
        ...
        Ape ape1 = new Ape(200,30,10);
        Ape ape2 = new Ape(200,30,10);
        Ape ape3 = new Ape(200,30,10);
        getApeContainer().add(ape1);
        getApeContainer().add(ape2);
        getApeContainer().add(ape3);
